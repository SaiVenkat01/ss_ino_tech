...
// import logo from '../../assets/company_logo_01.jpg'
// const Navbar = () => {
//   const [menu, openMenu] = useState(false);
//   const [showMenu, setShowMenu] = useState(true);
//   return (
//     <nav className="flex flex-wrap justify-between md:items-center bg-blue-800 text-black px-10 py-5 md:px-20">
...
//           </a>
//         </ul>
//         <span className="text-xl font-bold tracking-wide"><img className='w-50 h-40' src={logo} alt=""/></span>
